...
export type GetUserByJwtUidQueryVariables = Exact<{
  jwt_uid: Scalars['String'];
}>;
...
export const GetUserDocument = gql`
  ...
  users(where: {id: {_eq: $user_id}}) {
    ...
    `;
export const GetUserByJwtUidDocument = gql`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    updateUsername(variables: UpdateUsernameMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<UpdateUsernameMutation> {
      return withWrapper(() => client.request<UpdateUsernameMutation>(UpdateUsernameDocument, variables, requestHeaders));
    },
    getUser(variables: GetUserQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetUserQuery> {
      return withWrapper(() => client.request<GetUserQuery>(GetUserDocument, variables, requestHeaders));
    },
    getUserByJwtUid(variables: GetUserByJwtUidQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetUserByJwtUidQuery> {
      return withWrapper(() => client.request<GetUserByJwtUidQuery>(GetUserByJwtUidDocument, variables, requestHeaders));
    }
  };
}
